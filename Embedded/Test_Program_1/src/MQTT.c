...
extern const char certificate_pem_crt_start[] asm("_binary_8bada3167f_certificate_pem_crt_start");
extern const char certificate_pem_crt_end[] asm("_binary_8bada3167f_certificate_pem_crt_end");
extern const char private_pem_key_start[] asm("_binary_8bada3167f_private_pem_key_start");
extern const char private_pem_key_end[] asm("_binary_8bada3167f_private_pem_key_end");
